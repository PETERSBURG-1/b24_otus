...
/**
 * Компонент совместимости для старого имени form.designer.
 */
final class RexpCompatFormDesignerComponent extends CBitrixComponent
{
    private const TARGET_COMPONENT = 'rexp.form:designer';
