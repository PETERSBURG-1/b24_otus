...
/**
 * Компонент совместимости для старого имени form.designer.drafts.
 */
final class RexpCompatFormDesignerDraftsComponent extends CBitrixComponent
{
    private const TARGET_COMPONENT = 'rexp.form:designer.drafts';
