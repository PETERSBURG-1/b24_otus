...
/**
 * Компонент совместимости для старого имени form.designer.bizproc.
 */
final class RexpCompatFormDesignerBizprocComponent extends CBitrixComponent
{
    private const TARGET_COMPONENT = 'rexp.form:designer.bizproc';
