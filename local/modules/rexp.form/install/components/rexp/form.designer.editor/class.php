...
/**
 * Компонент совместимости для старого имени form.designer.editor.
 */
final class RexpCompatFormDesignerEditorComponent extends CBitrixComponent
{
    private const TARGET_COMPONENT = 'rexp.form:designer.editor';
